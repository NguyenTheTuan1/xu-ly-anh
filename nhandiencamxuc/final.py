...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "HỆ THỐNG PHÂN LOẠI CẢM XÚC QUA KHUÔN MẶT CỦA CON NGƯỜI"))
    ...
    def fVid(self):
        ...
        while True:
            ...
            if maxindex is not None and 0 <= maxindex < len(emoji_dist):
                 self.outLabel.setPixmap(QtGui.QPixmap(emoji_dist[maxindex]))
            else:
                 print("Error: maxindex is not valid.")
